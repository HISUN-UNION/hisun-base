...
/**
 * 
 *<p>类名称：BaseController</p>
 *<p>类描述: 基础的Controller，定义了通用日志变量。</p>
 *<p>公司：湖南海数互联信息技术有限公司</p>
 *@创建人：Rocky
 *@创建时间：2014-12-8 下午2:57:09
...
public abstract class BaseController {
	...
	/*public boolean tenantSame(TenantEntity entity){
		return entity.getTenant().getId().equals(UserLoginDetailsUtil.getUserLoginDetails().getTenantId());
	}*/
}
